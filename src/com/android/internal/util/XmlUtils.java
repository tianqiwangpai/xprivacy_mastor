...
public class XmlUtils
{
	 ...
	 * read back with readThisValueXml(). Currently supported value types are:
	 * null, String, Integer, Long, Float, Double Boolean, Map, List.
	 * 
	 * @param v
	...
	private static final Object readThisPrimitiveValueXml(XmlPullParser parser, String tagName) throws XmlPullParserException, java.io.IOException
	{
		try {
