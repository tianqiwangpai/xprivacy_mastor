...
public class ApplicationInfoEx implements Comparable<ApplicationInfoEx>
{
	...
	public static boolean secondef = false;
	public static boolean secondes = false;
	
	public static void resetseconde(){
		secondef = false;
		secondes = false;
	}
	...
	{
		return Integer.parseInt(PrivacyManager.getSetting(-getUid(), PrivacyManager.cSettingState, Integer.toString(STATE_CHANGED)));
	}
	...
	public int compareTo(ApplicationInfoEx other)
	{
		...
		return collator.compare(TextUtils.join(", ", getApplicationName()), TextUtils.join(", ", other.getApplicationName()));
	}
}
