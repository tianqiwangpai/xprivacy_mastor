...
public class RState
{
		...
		if (methodName == null) {
			if (restrictionName == null) {
				...
				for (PRestriction restriction : PrivacyManager.getRestrictionList(uid, restrictionName)) {
					...
					if (version != null && hook != null && hook.getFrom() != null && version.compareTo(hook.getFrom()) < 0)
						continue;
	...
	public void toggleAsked()
	{
		...
		if (mRestrictionName == null)
			...
			PrivacyManager.setSetting(mUid, PrivacyManager.cSettingState, Integer.toString(ApplicationInfoEx.STATE_CHANGED));
