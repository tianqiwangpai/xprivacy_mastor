...
public class XAccountManager extends XHook
{
	...
	// listener, Handler handler, boolean updateImmediately)
	// public String blockingGetAuthToken(Account account, String authTokenType,
	// boolean notifyAuthFailure)
	// public Account[] getAccounts()
	// public Account[] getAccountsByType(String type)
	// public Account[] getAccountsByTypeForPackage(String type, String
	// packageName)
	// public AccountManagerFuture<Account[]> getAccountsByTypeAndFeatures(final
	// String type, final String[] features, AccountManagerCallback<Account[]>
	// callback, Handler handler)
	// public AuthenticatorDescription[] getAuthenticatorTypes()
	// public AccountManagerFuture<Bundle> getAuthToken(final Account account,
	// final String authTokenType, final Bundle options, final Activity
	// activity, AccountManagerCallback<Bundle> callback, Handler handler)
	// public AccountManagerFuture<Bundle> getAuthToken(final Account account,
	// final String authTokenType, final boolean notifyAuthFailure,
	// AccountManagerCallback<Bundle> callback, Handler handler)
	// public AccountManagerFuture<Bundle> getAuthToken(final Account account,
	// final String authTokenType, final Bundle options, final boolean
	// notifyAuthFailure, AccountManagerCallback<Bundle> callback, Handler
	// handler)
	// public AccountManagerFuture<Bundle> getAuthTokenByFeatures(final String
	// accountType, final String authTokenType, final String[] features, final
	// Activity activity, final Bundle addAccountOptions, final Bundle
	// getAuthTokenOptions, final AccountManagerCallback<Bundle> callback, final
	// Handler handler)
	// public AccountManagerFuture<Boolean> hasFeatures(final Account account,
	// final String[] features, AccountManagerCallback<Boolean> callback,
	// Handler handler)
	// public void removeOnAccountsUpdatedListener(OnAccountsUpdateListener
	// listener)
	...
	// accountType) throws android.os.RemoteException;
	// public android.accounts.Account[] getAccountsAsUser(java.lang.String
	// accountType, int userId) throws android.os.RemoteException;
	// public void
	// getAccountsByFeatures(android.accounts.IAccountManagerResponse response,
	// java.lang.String accountType, java.lang.String[] features) throws
	...
	private enum Methods {
		addOnAccountsUpdatedListener, blockingGetAuthToken, getAccounts, getAccountsByType, getAccountsByTypeForPackage, getAccountsByTypeAndFeatures, getAuthenticatorTypes, getAuthToken, getAuthTokenByFeatures, hasFeatures, removeOnAccountsUpdatedListener,

		Srv_getAccounts, Srv_getAccountsAsUser, Srv_getAccountsByFeatures, Srv_getSharedAccountsAsUser
	};
	...
	{
		try {
			boolean allowed = PrivacyManager.getSettingBool(-uid, Meta.cTypeAccountHash, accountName + accountType, false);
