...
public class XAppIndexApi extends XHook
{
	...
	// abstract PendingResult<Status> view(GoogleApiClient apiClient, Activity
	// activity, Intent viewIntent, String title, Uri webUrl,
	// List<AppIndexApi.AppIndexingLink> outLinks)
	// abstract PendingResult<Status> view(GoogleApiClient apiClient, Activity
	// activity, Uri appIndexingUrl, String title, Uri webUrl,
	// List<AppIndexApi.AppIndexingLink> outLinks)
	// abstract PendingResult<Status> viewEnd(GoogleApiClient apiClient,
	// Activity activity, Uri appIndexingUrl)
	// abstract PendingResult<Status> viewEnd(GoogleApiClient apiClient,
	// Activity activity, Intent viewIntent)
