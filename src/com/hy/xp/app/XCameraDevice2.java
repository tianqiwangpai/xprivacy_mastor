...
public class XCameraDevice2 extends XHook
{
	...
	// public int capture(CaptureRequest request, CaptureListener listener,
	// Handler handler)
	// public int captureBurst(List<CaptureRequest> requests, CaptureListener
	// listener, Handler handler)
	// public int setRepeatingRequest(CaptureRequest request, CaptureListener
	// listener, Handler handler)
	// public int setRepeatingBurst(List<CaptureRequest> requests,
	// CaptureListener listener, Handler handler)
