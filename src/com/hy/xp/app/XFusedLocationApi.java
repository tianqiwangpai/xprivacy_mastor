...
public class XFusedLocationApi extends XHook
{
	...
	// abstract PendingResult<Status> removeLocationUpdates(GoogleApiClient
	// client, LocationListener listener)
	// abstract PendingResult<Status> removeLocationUpdates(GoogleApiClient
	// client, PendingIntent callbackIntent)
	// abstract PendingResult<Status> requestLocationUpdates(GoogleApiClient
	// client, LocationRequest request, LocationListener listener, Looper
	// looper)
	// abstract PendingResult<Status> requestLocationUpdates(GoogleApiClient
	// client, LocationRequest request, LocationListener listener)
	// abstract PendingResult<Status> requestLocationUpdates(GoogleApiClient
