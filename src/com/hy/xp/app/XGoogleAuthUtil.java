...
public class XGoogleAuthUtil extends XHook
{
	...
	// static String getToken(Context context, String accountName, String scope,
	// Bundle extras)
	// static String getTokenWithNotification(Context context, String
	// accountName, String scope, Bundle extras)
	// static String getTokenWithNotification(Context context, String
	// accountName, String scope, Bundle extras, Intent callback)
	// static String getTokenWithNotification(Context context, String
	// accountName, String scope, Bundle extras, String authority, Bundle
	// syncBundle)
	...
	public static List<XHook> getInstances()
	{
		...
		listHook.add(new XGoogleAuthUtil(Methods.getTokenWithNotification, PrivacyManager.cAccounts, "getTokenWithNotificationGoogle"));
		return listHook;
	}
