...
public class XLocationClient extends XHook
{
	...
	// LocationClient.OnAddGeofencesResultListener listener)
	...
	// void requestLocationUpdates(LocationRequest request, PendingIntent
	// callbackIntent)
	// void requestLocationUpdates(LocationRequest request, LocationListener
	// listener)
	// void requestLocationUpdates(LocationRequest request, LocationListener
