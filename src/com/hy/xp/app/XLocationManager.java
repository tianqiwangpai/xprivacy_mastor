...
public class XLocationManager extends XHook
{
	...
	// ILocationListener listener, android.app.PendingIntent intent,
	...
	// android.app.PendingIntent intent, java.lang.String packageName)
	// public void removeGeofence(Geofence fence, android.app.PendingIntent
	// intent, java.lang.String packageName)
	// public Location getLastLocation(LocationRequest request, java.lang.String
	// packageName)
	...
	// public java.util.List<java.lang.String> getProviders(Criteria criteria,
	// boolean enabledOnly)
	// public java.lang.String getBestProvider(Criteria criteria, boolean
	// enabledOnly)
	// public boolean isProviderEnabled(java.lang.String provider)
	// public boolean sendExtraCommand(java.lang.String provider,
	// java.lang.String command, android.os.Bundle extras)
	...
	private enum Methods {
		addGeofence, addGpsStatusListener, addNmeaListener, addProximityAlert, getAllProviders, getBestProvider, getProviders, isProviderEnabled, getGpsStatus, getLastKnownLocation, removeUpdates, requestLocationUpdates, requestSingleUpdate, sendExtraCommand,

		Srv_requestLocationUpdates, Srv_removeUpdates, Srv_requestGeofence, Srv_removeGeofence, Srv_getLastLocation, Srv_addGpsStatusListener, Srv_removeGpsStatusListener, Srv_getAllProviders, Srv_getProviders, Srv_getBestProvider, Srv_isProviderEnabled, Srv_sendExtraCommand
	};
		...
		if (!cClassName.equals(className)) {
			...
			for (Methods loc : Methods.values())
				if (loc == Methods.removeUpdates)
					...
					listHook.add(new XLocationManager(loc, PrivacyManager.cLocation, "com.android.server.LocationManagerService"));
				else
