...
public class XTelephonyManager1 extends XHook
{
	...
	private XTelephonyManager1(Methods method, String restrictionName, Srv srv)
	{
	...
	private XTelephonyManager1(Methods method, String restrictionName, String className)
	{
	...
	// public void listen(java.lang.String pkg, IPhoneStateListener callback,
	...
	// public java.util.List<android.telephony.NeighboringCellInfo>
	...
	private enum Methods {
		...
		Srv_getDeviceId, Srv_getGroupIdLevel1, Srv_getIccSerialNumber, Srv_getIsimDomain, Srv_getIsimImpi, Srv_getIsimImpu, Srv_getLine1AlphaTag, Srv_getLine1Number, Srv_getMsisdn, Srv_getSubscriberId, Srv_getCompleteVoiceMailNumber, Srv_getVoiceMailNumber, Srv_getVoiceMailAlphaTag,

		Srv_listen,

		Srv_enableLocationUpdates, Srv_disableLocationUpdates, Srv_getAllCellInfo, Srv_getCellLocation, Srv_getNeighboringCellInfo
	};
	...
	public static List<XHook> getInstances(String className)
	{
		...
		if (!cClassName.equals(className)) {
			...
			listHook.add(new XTelephonyManager1(Methods.disableLocationUpdates, null, className));
			listHook.add(new XTelephonyManager1(Methods.enableLocationUpdates, PrivacyManager.cLocation, className));
			listHook.add(new XTelephonyManager1(Methods.getAllCellInfo, PrivacyManager.cLocation, className));
			listHook.add(new XTelephonyManager1(Methods.getCellLocation, PrivacyManager.cLocation, className));

			listHook.add(new XTelephonyManager1(Methods.getDeviceId, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getGroupIdLevel1, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getIsimDomain, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getIsimImpi, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getIsimImpu, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getLine1AlphaTag, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getLine1Number, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getMsisdn, PrivacyManager.cPhone, className));

			listHook.add(new XTelephonyManager1(Methods.getNeighboringCellInfo, PrivacyManager.cLocation, className));

			listHook.add(new XTelephonyManager1(Methods.getSimSerialNumber, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getSubscriberId, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getVoiceMailAlphaTag, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getVoiceMailNumber, PrivacyManager.cPhone, className));

			listHook.add(new XTelephonyManager1(Methods.listen, PrivacyManager.cLocation, className));
			listHook.add(new XTelephonyManager1(Methods.listen, PrivacyManager.cPhone, className));

			// No permissions required
			listHook.add(new XTelephonyManager1(Methods.getNetworkCountryIso, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getNetworkOperator, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getNetworkOperatorName, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getSimCountryIso, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getSimOperator, PrivacyManager.cPhone, className));
			listHook.add(new XTelephonyManager1(Methods.getSimOperatorName, PrivacyManager.cPhone, className));

			// PhoneSubInfo
			listHook.add(new XTelephonyManager1(Methods.Srv_getDeviceId, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getGroupIdLevel1, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getIccSerialNumber, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getIsimDomain, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getIsimImpi, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getIsimImpu, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getLine1AlphaTag, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getLine1Number, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getMsisdn, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getSubscriberId, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getCompleteVoiceMailNumber, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getVoiceMailAlphaTag, PrivacyManager.cPhone, Srv.SubInfo));
			listHook.add(new XTelephonyManager1(Methods.Srv_getVoiceMailNumber, PrivacyManager.cPhone, Srv.SubInfo));

			listHook.add(new XTelephonyManager1(Methods.Srv_listen, PrivacyManager.cLocation, Srv.Registry));
			listHook.add(new XTelephonyManager1(Methods.Srv_listen, PrivacyManager.cPhone, Srv.Registry));
		}
		return listHook;
	}
	...
	public static List<XHook> getPhoneInstances()
	{
		List<XHook> listHook = new ArrayList<XHook>();
		if (Hook.isAOSP(19)) {
			listHook.add(new XTelephonyManager1(Methods.Srv_enableLocationUpdates, PrivacyManager.cLocation, Srv.Phone));
			listHook.add(new XTelephonyManager1(Methods.Srv_disableLocationUpdates, null, Srv.Phone));
			listHook.add(new XTelephonyManager1(Methods.Srv_getAllCellInfo, PrivacyManager.cLocation, Srv.Phone));
			listHook.add(new XTelephonyManager1(Methods.Srv_getCellLocation, PrivacyManager.cLocation, Srv.Phone));
			listHook.add(new XTelephonyManager1(Methods.Srv_getNeighboringCellInfo, PrivacyManager.cLocation, Srv.Phone));
		}
		return listHook;
	}
