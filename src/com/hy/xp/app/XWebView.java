...
public class XWebView extends XHook
{
	...
	{
		super(restrictionName, (method == Methods.WebView ? null : method.name()), (method == Methods.WebView ? method.name() : null));
		mMethod = method;
	}
	...
	// privateBrowsing)
	// public WebView(Context context, AttributeSet attrs, int defStyleAttr, int
	// defStyleRes)
	// protected WebView(Context context, AttributeSet attrs, int defStyle,
	// Map<String, Object> javaScriptInterfaces, boolean privateBrowsing)
	// public WebSettings getSettings()
	// public void loadUrl(String url)
	// public void loadUrl(String url, Map<String, String>
