...
public class XWifiManager extends XHook
{
	...
	// public java.util.List<android.net.wifi.BatchedScanResult>
	// getBatchedScanResults(java.lang.String callingPackage)
	// public java.util.List<android.net.wifi.WifiConfiguration>
	// getConfiguredNetworks()
	// public android.net.wifi.WifiInfo getConnectionInfo()
	// public android.net.DhcpInfo getDhcpInfo()
	// public java.util.List<android.net.wifi.ScanResult>
	// getScanResults(java.lang.String callingPackage)
	...
	private enum Methods {
		getConfiguredNetworks, getConnectionInfo, getDhcpInfo, getScanResults, getWifiApConfiguration, Srv_getBatchedScanResults, Srv_getConfiguredNetworks, Srv_getConnectionInfo, Srv_getDhcpInfo, Srv_getScanResults, Srv_getWifiApConfiguration
	};
	...
	public static List<XHook> getInstances(String className)
	{
		...
		if (!cClassName.equals(className)) {
			...
			listHook.add(new XWifiManager(Methods.Srv_getScanResults, PrivacyManager.cLocation, "com.android.server.wifi.WifiService"));
			...
			listHook.add(new XWifiManager(Methods.Srv_getConnectionInfo, PrivacyManager.cInternet, "com.android.server.wifi.WifiService"));
		}
